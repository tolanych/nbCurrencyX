...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('nbcurrencyx', MODX_CORE_PATH . 'components/nbcurrencyx/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/nbcurrencyx/model/schema/nbcurrencyx.mysql.schema.xml';
